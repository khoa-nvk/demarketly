 ...
 */
declare function delegateSignatureCommon(ids: Encoded.Any[], { onAccount, onNode, ...opt }: {
    onAccount: AccountBase;
    onNode: Node;
} & Parameters<AccountBase['sign']>[1]): Promise<string>;
/**
 ...
 * ```
 */
export declare function createAensDelegationSignature(contractId: Encoded.ContractAddress, opt: Parameters<AccountBase['address']>[0] & Parameters<typeof delegateSignatureCommon>[1] & {
    name?: AensName;
}): Promise<string>;
/**
 ...
 * ```
 */
export declare function createOracleDelegationSignature(contractId: Encoded.ContractAddress, opt: Parameters<AccountBase['address']>[0] & Parameters<typeof delegateSignatureCommon>[1] & {
