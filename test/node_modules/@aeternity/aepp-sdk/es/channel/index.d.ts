...
import { SignTx, ChannelOptions, ChannelState } from './internal';
...
export default class Channel {
     ...
     * ```
     */
    shutdown(sign: Function): Promise<Encoded.Transaction>;
    /**
    ...
    static reconnect(options: ChannelOptions, txParams: any): Promise<Channel>;
}
export {};
