 ...
 * repository.
 */
import { genSalt } from "./utils/crypto.mjs";
import { commitmentHash, isAuctionName } from "./tx/builder/helpers.mjs";
import { CLIENT_TTL, NAME_TTL, Tag } from "./tx/builder/constants.mjs";
import { ArgumentError } from "./utils/errors.mjs";
import { send } from "./spend.mjs";
import { getName, getHeight } from "./chain.mjs";
 ...
 * ```
 */
export async function aensRevoke(name, options) {
 ...
 * ```
 */
export async function aensUpdate(name, pointers, _ref) {
  let {
    extendPointers,
    ...options
  } = _ref;
 ...
 * ```
 */
export async function aensTransfer(name, account, options) {
 ...
 * ```
 */
export async function aensQuery(name, opt) {
...
export async function aensClaim(name, salt, options) {
 ...
 * ```
 */
export async function aensPreclaim(name, options) {
  const salt = genSalt();
 ...
 * ```
 */
export async function aensBid(name, nameFee, options) {
