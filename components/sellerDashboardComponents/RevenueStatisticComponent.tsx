...
export default function RevenueStatisticComponent(props: any) {
            ...
            <div className="card card-rounded">
              <div className="card-body">
                <div className="d-sm-flex justify-content-between align-items-start">
                  <div>
                    <h3 className="card-title card-title-dash">Revenue infomation </h3>
                    <p className="card-subtitle card-subtitle-dash">
                      Detail revenue of each product 
                    </p>
                  </div>
                  <div id="performance-line-legend" />
                </div>
                <div className={noData == true? "no-data-chart": 'display-none'}>
                    No data
                </div>
                <div className="chartjs-wrapper mt-3">
                  <canvas id="chartRevenue" ref={canvasEl} height="100" />
                </div>
