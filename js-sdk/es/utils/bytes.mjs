...
import { isBase64, isHex } from "./string.mjs";
/**
 * Bytes module
...
export function toBytes(val) {
  ...
  if (val === undefined || val === null) return _Buffer.from([]);
...
export function str2buf(str, enc) {
  ...
  return _Buffer.from(str, (_ref = enc !== null && enc !== void 0 ? enc : isHex(str) ? 'hex' : undefined) !== null && _ref !== void 0 ? _ref : isBase64(str) ? 'base64' : undefined);
}
