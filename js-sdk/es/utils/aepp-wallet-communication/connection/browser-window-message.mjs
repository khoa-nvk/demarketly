...
import { getBrowserAPI, isInIframe } from "../helpers.mjs";
import { AlreadyConnectedError, NoWalletConnectedError, MessageDirectionError } from "../../errors.mjs";
/**
 * Check if connected
...
function sendMessage(msg) {
  const message = this.sendDirection ? {
...
//# sourceMappingURL=browser-window-message.mjs.map